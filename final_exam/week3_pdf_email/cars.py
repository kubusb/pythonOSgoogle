...
def process_data(data):
  ...
  for item in data:
    ...
    if item["total_sales"] > most_sold_car_num:
        most_sold_car_num = item["total_sales"]
        most_sold_car_make = item["car"]["car_model"]
    # TODO: also handle most popular car_year
    if item["car"]["car_year"] not in years_dictionary:
        years_dictionary[item["car"]["car_year"]] = 0
